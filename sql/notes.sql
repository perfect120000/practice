...
insert into salesman_master values(0003,'raj','p-7','bandra','mumbai',40032,'maharashtra',3000,200,100,'Good');
insert into salesman_master values(0003,'ashish','A/5','juhu','mumbai',40044,'maharashtra',3500,200,150,'Good');
...
create table student2( id varchar(10) primary key,name varchar(10),conatct numeric(10),course_id varchar(10),constraint FK_students_course foreign key(course_id)references course(course_id));